    ...
    while True:
        ...
        if override_active:
            ...
            if elapsed < override_duration:
                fade_channel(upper_channels[override_effect], 0.5, override_fade_speed)
                fade_channel(upper_channels[override_blend], 0.5, override_fade_speed)
            else:
                # Fade out
