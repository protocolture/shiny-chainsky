...
volume_pot = PiicoDev_Potentiometer(id=[1,0,0,0])       # Master volume (slide pot)
leds = PiicoDev_RGB()

total_channels = 32  # Base radio: 0-15, FX: 30+
...
# === Load upper FX/static channels (30+) ===
...
try:
    while True:
        ...
        # === Trigger effect event every 60s ===
